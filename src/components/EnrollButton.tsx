...
/**
 * EnrollButton - Canonical Primary CTA Component
 * 
 * This is the SINGLE source of truth for all "Enroll now" buttons across the site.
...
interface EnrollButtonProps {
  ...
  fullWidth?: boolean;
  /** Custom label - defaults to "Enroll now" */
  label?: string;
  /** Click handler */
  onClick?: () => void;
...
const EnrollButton = React.forwardRef<HTMLButtonElement, EnrollButtonProps>(
  ({ 
    size = "default", 
    ...
    const handleClick = () => {
      ...
      // If not on homepage, navigate there with pricing hash
...
export { EnrollButton, scrollToPricing };
