...
const SocialProof = () => {
  const avatars = [
    { src: avatar1, alt: "Student avatar" },
    { src: avatar2, alt: "Student avatar" },
    { src: avatar3, alt: "Student avatar" },
    { src: avatar4, alt: "Student avatar" },
    { src: avatar5, alt: "Student avatar" },
  ];

  return (
    <div className="flex flex-col sm:flex-row items-start justify-start gap-3 sm:gap-4">
      {/* Avatar Group */}
      <div className="flex -space-x-2.5 flex-shrink-0" role="img" aria-label="Profile photos of enrolled students">
      ...
      <div className="text-left">
        <p className="text-sm sm:text-base text-foreground font-medium">
          2,000+ professionals already ahead of you
        </p>
